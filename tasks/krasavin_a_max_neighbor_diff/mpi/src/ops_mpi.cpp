...
KrasavinAMaxNeighborDiffMPI::KrasavinAMaxNeighborDiffMPI(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
  GetOutput() = 0;
}

bool KrasavinAMaxNeighborDiffMPI::ValidationImpl() {
  return true;
}

bool KrasavinAMaxNeighborDiffMPI::PreProcessingImpl() {
  return true;
}

bool KrasavinAMaxNeighborDiffMPI::RunImpl() {
  int world_rank = 0;
  int world_size = 0;
...
bool KrasavinAMaxNeighborDiffMPI::PostProcessingImpl() {
  return true;
}
